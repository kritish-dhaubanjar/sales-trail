...
build: install
	...
	sed -i "s|<PUSHER_APP_KEY>|$(PUSHER_APP_KEY)|g" app/next.config.mjs
	sed -i "s|<SENTRY_DSN>|$(SENTRY_DSN)|g" app/next.config.mjs
	sed -i "s|<SENTRY_ENVIRONMENT>|$(SENTRY_ENVIRONMENT)|g" app/next.config.mjs
